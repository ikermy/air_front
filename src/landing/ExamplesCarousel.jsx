...
const ExamplesCarousel = () => {
    const examples = [
        ...
        },
        {
            ...
            items: [
                "Клиент в Telegram присылает скан договора — агент распознаёт текст, проверяет наличие ключевых пунктов и отвечает в чате с пометками.",
                "В WhatsApp сотрудник отправляет фото квитанции — бот заносит данные в CRM и присылает PDF‑отчёт.",
                "В Instagram через Direct клиент присылает аудиоотзыв — агент делает расшифровку и добавляет как текст к публикации."
            ]
        },
        {
            icon: "🌐",
            ...
            items: [
                ...
                "Отслеживание упоминаний в Instagram: если кто-то отмечает ваш профиль в сторис или посте, агент уведомляет в удобном мессенджере.",
        ...
        },
        {
            ...
            items: [
                ...
                "Новое фото продукта загрузили в Instagram → агент вытащил изображение, создал описание и опубликовал пост в Telegram и WhatsApp‑каналах."
            ]
        }
    ];
