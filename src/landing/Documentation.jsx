...
const Documentation = () => {
    ...
    const documentationSections = [
        {
            key: 'models',
            title: 'Создание и управление ассистентами',
            ...
            items: [
                ...
                },
                {
                    ...
                    content: 'Создание системных инструкций для определения поведения ассистента. Промпты определяют роль, стиль общения и специализацию.'
                },
                {
    ...
    return (
        <div className="documentation-section" id="documentation-section">
            ...
            <Paragraph className="documentation-intro">
                ...
                и узнайте, как эффективно настроить ассистента для ваших задач.
            </Paragraph>
