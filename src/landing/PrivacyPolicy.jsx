    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <Typography.Paragraph>
                Настоящая Политика конфиденциальности (далее — «Политика») регулирует порядок обработки и защиты персональных данных пользователей сайта [название сайта] (далее — «Сайт»), на котором пользователи создают и используют собственные модели ИИ-агентов.
            ...
            <Typography.Paragraph>
                - Доступ к данным имеют только автоматизированные процессы, необходимые для выполнения функций агента, и они не передаются третьим лицам.
            </Typography.Paragraph>
            <Typography.Paragraph>
