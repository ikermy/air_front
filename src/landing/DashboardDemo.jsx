            ...
            <div className="dashboard-demo-content">
                <div className="demo-header">
                    <h2 className="intro-title">
                        <span className="highlight">Маруся AI</span> — панель управления AI-ассистента
                    </h2>
                    <Paragraph className="demo-description">
                        Полный контроль над вашим ассистентом в удобном интерфейсе
                    </Paragraph>
                </div>
                        ...
                        <div className="demo-quick-start-content">
                            ...
                            >
                                ...
                                <Text className="demo-quick-start-text">
                                    Создайте ассистента за 5 минут и подключите его к любому мессенджеру
                                </Text>
                            </div>
                        </div>
                    </Card>
